...
const metrics = [
  { value: "100,000+", label: "Active Users Across Axpert", description: "Proven enterprise deployment scale" },
  { value: "750+", label: "Enterprises Running on Axi", description: "Global enterprise client base" },
  { value: "10+", label: "Countries Live Today", description: "Multi-national operations" },
  { value: "4.9/5", label: "Average Customer Rating", description: "Based on 30+ customer reviews" },
];
...
export default function AnalyticsSection() {
  ...
  return (
    <section
      ...
      style={{
        background: "linear-gradient(135deg, #00007f 0%, #1a1a5e 50%, #2d1040 100%)",
      }}
    >
      {/* Ambient glow */}
      ...
      <div className="absolute inset-0 opacity-15">
        ...
        <div className="absolute top-40 right-32 w-1.5 h-1.5 rounded-full bg-[#fc8151] animate-pulse" style={{ animationDelay: "0.5s" }} />
        <div className="absolute bottom-32 left-1/3 w-1 h-1 rounded-full bg-white animate-pulse" style={{ animationDelay: "1s" }} />
        <div className="absolute bottom-20 right-1/4 w-2 h-2 rounded-full bg-[#fc8151] animate-pulse" style={{ animationDelay: "1.5s" }} />
        <div className="absolute top-1/2 left-16 w-1 h-1 rounded-full bg-white animate-pulse" style={{ animationDelay: "0.8s" }} />
        <div className="absolute top-1/3 right-16 w-1.5 h-1.5 rounded-full bg-white animate-pulse" style={{ animationDelay: "2s" }} />
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="glass-dark rounded-3xl p-4">
              <div className="relative rounded-2xl overflow-hidden">
                <img
                  src="/orbital-network_03a94a6d.webp"
          ...
          >
            <h2 className="font-[Space_Grotesk] text-4xl md:text-5xl font-bold text-white mb-5 leading-tight">
              Priority <span className="bg-gradient-to-r from-[#fc8151] to-[#ff6b9d] bg-clip-text text-transparent">geographies</span>
            </h2>
            ...
            <p className="text-base text-white/60 mb-10 leading-relaxed">
              Built for businesses where operations are complex, assets are critical, and every decision impacts the bottom line — meet AXI
            </p>
            ...
            <div className="grid grid-cols-2 gap-5">
              {metrics.map((metric, index) => (
                <motion.div
                  ...
                  transition={{ duration: 0.7, delay: 0.3 + index * 0.1, ease: [0.23, 1, 0.32, 1] }}
                ...
                >
                  ...
                  <p className="text-xs md:text-sm font-semibold uppercase tracking-wider text-white/80 mt-2">{metric.label}</p>
