...
const html = fs.readFileSync('scratch/bidhannagar_cs_page.html', 'utf8');
...
fs.writeFileSync('scratch/bidhannagar_cs_details.txt', log);
console.log('Saved bidhannagar_cs_details.txt, length:', log.length);
