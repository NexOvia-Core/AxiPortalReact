...
const html = fs.readFileSync('scratch/healthcare_page.html', 'utf8');
...
// Find elementor widget containers text
...
fs.writeFileSync('scratch/healthcare_details.txt', log);
console.log('Saved healthcare_details.txt, length:', log.length);
