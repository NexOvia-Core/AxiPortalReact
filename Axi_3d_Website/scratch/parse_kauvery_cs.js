...
const html = fs.readFileSync('scratch/kauvery_cs_page.html', 'utf8');
...
fs.writeFileSync('scratch/kauvery_cs_details.txt', log);
console.log('Saved kauvery_cs_details.txt, length:', log.length);
