...
const html = fs.readFileSync('scratch/ksbc_page.html', 'utf8');
...
fs.writeFileSync('scratch/ksbc_details.txt', log);
console.log('Saved ksbc_details.txt, length:', log.length);
