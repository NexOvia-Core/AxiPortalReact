...
const html = fs.readFileSync('scratch/sipf_page.html', 'utf8');
...
fs.writeFileSync('scratch/sipf_details.txt', log);
console.log('Saved sipf_details.txt, length:', log.length);
